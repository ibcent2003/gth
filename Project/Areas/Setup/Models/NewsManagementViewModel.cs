...
namespace Project.Areas.Setup.Models
{
    public class NewsManagementViewModel : PageInfoModel
    {
      ...
      //  public SelectList  { get; set; }
        public List<IntegerSelectListItem> NewsCategory { get; set; }
    ...
    public class NewsForm
    {
        ...
        //[Required(ErrorMessage = "Please enter the News Sample")]
        //[Display(Name = "News Sample")]
        //public string NewsSample { get; set; }
        ...
        [Required(ErrorMessage = "Please select the news category")]
